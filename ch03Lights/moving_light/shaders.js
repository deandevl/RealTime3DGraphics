...
void main(void) {
  ...
  vec3 light_v3 = vec3(u_modelview_m4 * vec4(u_lightdirection_v3, 0.));    

  // Normalized light direction
  vec3 L_v3 = normalize(light_v3);
  ...
  vec3 Id_v3 = u_materialdiffuse_v3 * u_lightdiffuse_v3 * lambertTerm_f;

  // Set the varying to be used inside of the fragment shader
  v_color_v4 = vec4(Id_v3, 1.0);
